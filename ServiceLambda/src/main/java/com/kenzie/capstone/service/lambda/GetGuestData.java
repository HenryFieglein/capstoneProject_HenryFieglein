...
public class GetGuestData implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent input, Context context) {
        ...
        try {
            Guest guest = lambdaService.getGuestData(id);
            String output = gson.toJson(guest);
